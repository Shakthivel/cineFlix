...
body {
	background-image:
		url("https://res.cloudinary.com/dfep0loer/image/upload/v1638642281/CineFlix/login-bg_oinwnx.jpg");
}
</style>
<!-- Title Icon -->
<link rel="icon"
	href="https://res.cloudinary.com/dfep0loer/image/upload/v1638639673/CineFlix/favicon_k3r3vp.ico"
	type="image/x-icon">
<!-- Title -->
...
<body>
	<div
		...
		<form class="login-form text-center " method="POST" novalidate
			id="login-form">
			<img
				src="https://res.cloudinary.com/dfep0loer/image/upload/v1638596050/CineFlix/cineflix-black_nleijx.png"
				class="img-fluid" alt="...">
			<h2 class="mb-5">Login</h2>
			<div class="form-group">
				<input type="number" id="uname" name="name"
					class="form-control form-control-lg " placeholder="Phone Number"
					required>
				<div class="valid-feedback">Sounds Great !</div>
				<div class="invalid-feedback">Oh No ! Enter a Value!</div>
			</div>
			...
			<div style="margin-top: 10px;">
				<a href="/user/register" class="form-link">Not an user?
					Register</a>
			</div>
