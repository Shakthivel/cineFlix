  ...
  <div class="modal-dialog">
    ...
    <ul class="list-group pl-3 pr-3">
      ...
      <div class="modal-footer">
        <a class="btn btn-primary btn-cineflex" href="#" role="button">Edit Profile</a>
        <a class="btn btn-warning btn-bookings" href="#" role="button">Your Bookings</a>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="card-deck" style="padding: 2rem;">
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">On the day of a public conference by the state's Chief Minister, his bodyguard and a
                                police officer become stuck in a
                                time loop.</p>
                        </div>
                    </div>
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Welcome to Raccoon City, once the booming home of pharmaceutical giant Umbrella Corp.
                                The company's exodus left the city
                                a wasteland, a dying town with great evil brewing below the surface. When that evil is unleashed, a
                                group of survivors
                                must work together to uncover the truth behind Umbrella and make it through the night.</p>
                        </div>
                    </div>
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">When a terrorist organization threatens to wipe out the superhuman society, the fate of
                                the world hangs in the balance
                                of the future heroes. Within hours until the collapse of civilization, Deku, Bakugo, and Todoroki must
                                work as a team,
                                but there is one problem: Deku's on the run for murder</p>
                        </div>
                    </div>
                ...
                <div class="card-deck" style="padding: 2rem;">
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">With Spider-Man's identity now revealed, our friendly neighborhood web-slinger is
                                unmasked and no longer able to
                                separate his normal life as Peter Parker from the high stakes of being a superhero. When Peter asks for
                                help from Doctor
                                Strange, the stakes become even more dangerous, forcing him to discover what it truly means to be
                                Spider-Man.</p>
                        </div>
                    </div>
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">On June 25, 1983, the Lord's Cricket Ground witnessed 14 men beat the twice over World
                                Champions West Indies, putting
                                India back onto the cricket world stage</p>
                        </div>
                    </div>
                    <div class="card shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">THE BATMAN is an edgy, action-packed thriller that depicts Batman in his early years,
