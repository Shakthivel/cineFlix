							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<a class="btn btn-warning btn-bookings" href="/history"
					...
					<c:if test="${status.first}">
						<div class="carousel-item active">
							<img src="${movie.getImageUrl() }" class="d-block w-100"
								style="object-fit: cover;" width="500px" height="545px">
						</div>
					</c:if>
							...
							<div class="card shadow p-3 mb-5">
								...
								<div class="card-footer">
									<a class="btn btn-dark btn-block btn-login"
										style="color: #fff;"
										href="/movie-${movie.getMovieId()}-availability" role="button">Book
										Tickets</a>
								</div>
							</div>
						</div>
